...
export default {
    server: {
        // baseUrl: _envS('$baseUrl', 'http://localhost/tj-mediation-server'),
        ...
        baseUrl: _envS('$baseUrl', 'http://192.168.0.173:8080/tj-mediation-server'),

        /** 纠纷扩展服务（案件类型、满意度等），需全路径对接时可单独配置 */
        expandBaseUrl: _envS('$expandBaseUrl', 'http://192.168.0.173:6582/tj-mediation-server-expand'),
