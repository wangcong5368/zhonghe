        ...
        <el-row v-if="SYS_YES_NO.sys_no === form.isSelf">
          ...
          <el-col :span="12">
            <el-form-item label="代理人证件号码" prop="agentCertNum"
              :rules="[{ validator: this.validCertNum(this.form.agentCertType), trigger: 'blur' }]">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="消费者身份类型" prop="consumerIdentityType"
              ...
              <el-select v-model="form.consumerIdentityType" placeholder="请选择消费者身份类型" @change="form.certType = null">
