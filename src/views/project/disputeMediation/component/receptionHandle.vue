        ...
        <el-form ref="form" :model="form" :rules="rules" label-width="120px">
            ...
            <div>
                ...
                <el-row v-if="SYS_YES_NO.sys_no === form.isSelf">
                    ...
                    <el-col :span="12">
                        <el-form-item label="代理人证件号码" prop="agentCertNum" :rules="[{ validator: this.validCertNum(this.form.agentCertType), trigger: 'blur' }]">
                ...
                <el-row v-if="SYS_YES_NO.sys_no === form.isSelf">
                    <el-col :span="12">
                        <el-form-item label="代理人联系方式" prop="agentPhone">
                            <el-input v-model="form.agentPhone" placeholder="请输入代理人联系方式" maxlength="11" show-word-limit oninput="value=value.replace(/[^\d]/g,'')" clearable />
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                ...
                <el-row>
                    ...
                    <el-col :span="12">
                        <el-form-item label="联系方式" prop="phone">
                            <el-input v-model="form.phone" placeholder="请输入联系方式" oninput="value=value.replace(/[^\d]/g,'')" maxlength="11" show-word-limit clearable />
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    ...
                    <el-col :span="12">
                        ...
                        >
                            <el-input v-model="form.certNum" placeholder="请输入证件号码" :maxlength="this.validCertNumLength(this.form.certType)" show-word-limit @input="cardNumChange" clearable />
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    ...
                    <el-col :span="12">
                        <el-form-item label="年龄" prop="age">
                            <el-input v-model="form.age" maxlength="3" show-word-limit placeholder="请输入年龄" oninput="value=value.replace(/[^\d]/g,'')" clearable />
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                ...
                <el-row>
                    <el-col :span="24">
                        <el-form-item label="单位或住址" prop="address">
                            <el-input v-model="form.address" type="textarea" placeholder="请输入单位或住址" maxlength="50" show-word-limit clearable :autosize="{ minRows: 1 }" />
                        </el-form-item>
                    </el-col>
                </el-row>
            ...
            <el-row>
                <el-col :span="24">
                    <el-form-item label="住所地" prop="deptAddress">
                        <el-input v-model="form.deptAddress" type="textarea" placeholder="请输入机构住所地" maxlength="100" show-word-limit clearable :autosize="{ minRows: 1 }" />
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row>
            ...
            <el-row>
                ...
                <el-col :span="12">
                    <el-form-item label="性别" prop="deptContactSex" :rules="[{ required: this.SYS_YES_NO.sys_no !== this.form.deptAcceptMediate, message: '性别为必填项', trigger: 'blur' }]">
            ...
            <el-row>
                <el-col :span="24">
                    ...
                    >
                        <el-input v-model="form.deptContactPosition" type="textarea" placeholder="请输入机构代表所在部门及职务" maxlength="30" show-word-limit clearable :autosize="{ minRows: 1 }" />
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row>
                <el-col :span="12">
                    ...
                    >
                        <el-input v-model="form.deptContactPhone" placeholder="请输入机构代表联系方式" maxlength="11" show-word-limit oninput="value=value.replace(/[^\d]/g,'')" clearable />
                    </el-form-item>
                </el-col>
            ...
            <el-row v-if="DEPT_TYPE.bankList.includes(form.deptType) || DEPT_TYPE.nonBankList.includes(form.deptType)">
                ...
                <el-col :span="12">
                    ...
                    >
                        <el-input v-model="form.deptHandlerPhone" placeholder="请输入经办人员联系电话" maxlength="11" show-word-limit clearable />
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row v-if="DEPT_TYPE.bankList.includes(form.deptType) || DEPT_TYPE.nonBankList.includes(form.deptType)">
                <el-col :span="12">
                    ...
                    >
                        <el-input v-model="form.deptHandlerCertNum" placeholder="请输入经办人身份证号" maxlength="18" show-word-limit clearable />
                    </el-form-item>
                </el-col>
            </el-row>
            ...
            <el-row>
                <el-col :span="24">
                    <el-form-item label="投诉内容" prop="complaintContent">
                        <el-input v-model="form.complaintContent" type="textarea" placeholder="请输入内容" maxlength="5000" show-word-limit clearable :autosize="{ minRows: 3 }" />
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row>
                <el-col :span="24">
                    <el-form-item label="主要诉求" prop="appeal">
                        <el-input v-model="form.appeal" type="textarea" placeholder="请输入内容" maxlength="400" show-word-limit clearable :autosize="{ minRows: 3 }" />
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row>
            ...
            <el-row>
                ...
                <el-col :span="12">
                    ...
                    >
                        <el-input v-model="form.involveAmount" placeholder="请输入涉案金额" maxlength="12" show-word-limit @input="validAmount(form.involveAmount, 'involveAmount')" clearable />
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row>
            ...
            <el-row>
                <el-col :span="12">
                    <el-form-item label="受理状态" prop="acceptStatus">
                        <el-select v-model="form.acceptStatus" placeholder="请选择受理状态" style="width: 100%" @change="form.rejectReason = null" clearable>
...
<script>
import { handle, handleReject } from '@/api/project/disputeMediation';
import Treeselect from '@riophae/vue-treeselect';
import '@riophae/vue-treeselect/dist/vue-treeselect.css';
import { DEPT_TYPE, SYS_YES_NO, SYS_SEX, DM_ACCEPT_STATUS, DM_ENTRY_CHANNEL, CERT_TYPE } from '@/views/constant/CommonConstant.js';
