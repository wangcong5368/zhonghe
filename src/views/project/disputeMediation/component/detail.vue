                    ...
                    <el-row v-if="form.oldDeptId && !$store.getters.userInfo.isDMInstitution">
                        <el-col :span="12">
                            <el-form-item label="原机构名称" prop="deptId">
                                <treeselect v-model="form.oldDeptId" :options="deptOptions" :normalizer="normalizer" disabled @input="deptChange" />
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                            <el-form-item label="原机构类型" prop="type">
                                <el-cascader v-model="form.oldDeptType" :options="dict.type.dept_type.options" :props="{ expandTrigger: 'hover', emitPath: false }" disabled style="width: 100%" />
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row>
                    ...
                    <el-row>
                        <el-col :span="24">
                            <el-form-item label="住所地" prop="deptAddress">
                                <el-input v-model="form.deptAddress" type="textarea" readonly maxlength="100" :autosize="{ minRows: 1 }" />
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row>
                        <el-col :span="12">
                            <el-form-item label="纠纷发生日期" prop="disputeDate">
                                <el-date-picker readonly v-model="form.disputeDate" type="date" value-format="yyyy-MM-dd" style="width: 100%"></el-date-picker>
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                    ...
                    <el-row v-if="DEPT_TYPE.insuranceList.includes(form.deptType)">
                        ...
                        <el-col :span="12">
                            <el-form-item label="险种类别2" prop="insuranceType2">
                                <el-input v-model="form.insuranceType2" placeholder="请输入险种类别2" clearable maxlength="40" show-word-limit readonly />
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row v-if="DEPT_TYPE.insuranceList.includes(form.deptType)">
                    ...
                    <el-row>
                        <el-col :span="24">
                            <el-form-item label="投诉内容" prop="complaintContent">
                                <el-input v-model="form.complaintContent" type="textarea" readonly maxlength="5000" :autosize="{ minRows: 3 }" />
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row>
                ...
                <el-row>
                    <el-col :span="24">
                        <el-form-item label="所在部门及职务" prop="deptContactPosition">
                            <el-input v-model="form.deptContactPosition" type="textarea" readonly maxlength="30" :autosize="{ minRows: 1 }" />
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                ...
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="联系方式" prop="deptContactPhone">
                            <el-input v-model="form.deptContactPhone" maxlength="11" readonly oninput="value=value.replace(/[^\d]/g,'')" />
                        </el-form-item>
                    </el-col>
                </el-row>
                    ...
                    <el-col :span="12">
                        <el-form-item label="金融机构拒绝调解原因" prop="deptRejectMediateReason" label-width="160px" v-if="SYS_YES_NO.sys_no === form.deptAcceptMediate">
                            <el-select v-model="form.deptRejectMediateReason" disabled style="width: 100%" placeholder="">
                                <el-option v-for="dict in dict.type.dm_dept_reject_mediate_reason" :key="dict.value" :label="dict.label" :value="dict.value"></el-option>
                            </el-select>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="金融机构拒绝调解备注" prop="deptRejectMediateRemark" label-width="160px" v-if="SYS_YES_NO.sys_no === form.deptAcceptMediate">
                            <el-input v-model="form.deptRejectMediateRemark" placeholder="" clearable maxlength="50" show-word-limit readonly />
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                        ...
                        <el-col :span="12">
                            <el-form-item label="签约方式" prop="signWay" v-if="form.signWay">
                                <el-select v-model="form.signWay" disabled style="width: 100%">
                                    <el-option v-for="dict in dict.type.dm_sign_way" :key="dict.value" :label="dict.label" :value="dict.value"></el-option>
                                </el-select>
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                            <el-form-item label="调解结果" prop="mediationResult" v-if="form.mediationResult">
                                <el-select v-model="form.mediationResult" disabled style="width: 100%">
                                    <el-option v-for="dict in dict.type.dm_mediation_result" :key="dict.value" :label="dict.label" :value="dict.value"></el-option>
                                </el-select>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row>
                        ...
                        <el-col :span="12">
                            <el-form-item label="办结时间" prop="finishTime" v-if="form.finishTime">
                                <el-date-picker readonly v-model="form.finishTime" type="date" value-format="yyyy-MM-dd" style="width: 100%"></el-date-picker>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row>
                        <el-col :span="12">
                            <el-form-item label="终止受理原因" prop="terminateReason" v-if="form.terminateReason && DM_FINISH_TYPE.terminateAccept === form.finishType">
                                <el-select v-model="form.terminateReason" disabled style="width: 100%">
                                    <el-option v-for="dict in dict.type.dm_terminate_accept_reason" :key="dict.value" :label="dict.label" :value="dict.value" />
                                </el-select>
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
...
import { getDisputeMediationExpandInfo, getProvinces, getCities } from '@/api/project/disputeMediation';
