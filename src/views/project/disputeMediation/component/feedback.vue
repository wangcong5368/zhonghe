  ...
  <el-dialog :title="title" :visible.sync="visible" width="1200px" append-to-body :close-on-click-modal="false"
    ...
    <el-form ref="form" :model="form" :rules="rules" label-width="120px">
      ...
      <el-row>
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="机构类型" prop="institutionType" label-width="125px">
              <el-select disabled v-model="form.institutionType" placeholder="" clearable style="width: 100%">
                <el-option v-for="dict in dict.type.dm_institution_type" :key="dict.value" :label="dict.label"
                  :value="dict.value"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="金融机构是否接受调解" prop="deptAcceptMediate" label-width="165px">
            <el-select v-model="form.deptAcceptMediate" :placeholder="disabled ? '' : '请选择金融机构是否接受调解'" clearable
        ...
        <el-col :span="24" v-if="form.createType === DM_CREATE_TYPE.TYPE2">
          <el-form-item label="人民调解申请书" prop="applicationAttachment"
            ...
            <file-upload v-model="form.applicationAttachment" :fileType="[
              ...
              :oldList="disabled && attachmentForm.applicationAttachment ? attachmentForm.applicationAttachment.split(',') : []" />
          </el-form-item>
        </el-col>
        <el-col :span="24">
...
<script>
import { feedback, getByDeptId } from '@/api/project/disputeMediation';
import Treeselect from '@riophae/vue-treeselect';
import '@riophae/vue-treeselect/dist/vue-treeselect.css';
import { DEPT_TYPE, SYS_YES_NO, SYS_SEX, DM_ACCEPT_STATUS, DM_ENTRY_CHANNEL, CERT_TYPE, DM_AGREEMENT_STEP, DM_STATUS, DM_CREATE_TYPE } from '@/views/constant/CommonConstant.js';
