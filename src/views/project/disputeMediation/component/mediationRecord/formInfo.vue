    ...
    <div>
        <el-form :model="formInfo" :rules="rules" ref="ruleForm" label-width="135px">
            <el-row>
                ...
                <el-col :span="12">
                    <el-form-item label="调解时间" prop="time" :rules="[{ required: !this.isEdit && true, message: '请选择调解时间', trigger: 'change' }]">
                        <el-date-picker
                ...
                <el-col :span="24">
                    <el-form-item label="参加人" prop="participant" :rules="[{ required: !this.isEdit && true, message: '请输入参加人', trigger: 'blur' }]">
                        <el-input
                            :placeholder="DM_STATUS.DM_STATUS10 === this.row.status || isEdit ? '' : '请输入参加人'"
                            v-model="formInfo.participant"
                            :disabled="DM_STATUS.DM_STATUS10 === this.row.status || isEdit"
                            maxlength="50"
                            show-word-limit
                            clearable
                ...
                <el-col :span="12">
                    <el-form-item label="调解结果" prop="result" :rules="[{ required: !this.isEdit && true, message: '请选择调解结果', trigger: 'change' }]">
                        <el-select
                            ...
                            :placeholder="DM_STATUS.DM_STATUS10 === this.row.status || isEdit ? '' : '请选择调解结果'"
                            style="width: 100%"
                            :disabled="DM_STATUS.DM_STATUS10 === this.row.status || isEdit"
                            clearable
                ...
                <el-col :span="12">
                    <el-form-item
                        ...
                        v-if="formInfo.result === DM_MEDIATION_RESULT.success"
                        clearable
                        :rules="[{ required: !this.isEdit && true, message: '请选择是否回访', trigger: 'change' }]"
                    >
                        <el-select
                            v-model="formInfo.needReturnVisit"
                            :placeholder="DM_STATUS.DM_STATUS10 === this.row.status || isEdit ? '' : '请选择是否回访'"
                            style="width: 100%"
                            :disabled="DM_STATUS.DM_STATUS10 === this.row.status || isEdit"
                        >
                ...
                <el-col :span="24">
                    <el-form-item
                        label="调解失败原因"
                        prop="failReason"
                        v-if="formInfo.result === DM_MEDIATION_RESULT.fail"
                        :rules="[{ required: !this.isEdit && true, trigger: 'blur', message: '请填写调解失败原因' }]"
                    >
                        <el-input
                            type="textarea"
                            v-model="formInfo.failReason"
            ...
            <el-row>
                <el-col :span="12">
                    <el-form-item label="是否申请司法确认" prop="isApplyJudicialCheck" :rules="[{ required: !this.isEdit && true, message: '请选择是否申请司法确认', trigger: 'change' }]">
                        <el-select
                            v-model="formInfo.isApplyJudicialCheck"
            ...
            <el-row class="line-row">
                <el-col :span="24">
                    <el-form-item label="案件标签" prop="caseLable">
                        <el-input
                            v-model="formInfo.caseLable"
                            :disabled="DM_STATUS.DM_STATUS10 === this.row.status || isEdit"
                            maxlength="50"
                            :placeholder="DM_STATUS.DM_STATUS10 === this.row.status || isEdit ? '' : '请输入案件标签'"
                            show-word-limit
                            clearable
                        ></el-input>
                    </el-form-item>
            ...
            <el-row>
                <el-col :span="24">
                    <el-form-item label="最终达成的其他调解事项" prop="otherAgreedMediationTerms">
                        <el-input
                            type="textarea"
                            v-model="formInfo.otherAgreedMediationTerms"
            ...
            <el-form-item label="消费者证件正反照" prop="consumerIdentificationPhoto">
                <file-upload
                    v-if="!isEdit || formInfo.consumerIdentificationPhoto"
                    v-model="formInfo.consumerIdentificationPhoto"
                    :isShowDele="!isEdit"
                    :isShowBtn="!isEdit"
                    :isShowTip="!isEdit"
                    :fileType="[
            ...
            <el-form-item label="机构证件正反照" prop="institutionIdentificationPhoto">
                <file-upload
                    v-if="!isEdit || formInfo.institutionIdentificationPhoto"
                    v-model="formInfo.institutionIdentificationPhoto"
                    :isShowDele="!isEdit"
                    :isShowBtn="!isEdit"
                    :isShowTip="!isEdit"
                    :fileType="[
            ...
            <el-form-item label="现场照片" prop="scenePhoto">
                <file-upload
                    v-if="!isEdit || formInfo.scenePhoto"
                    v-model="formInfo.scenePhoto"
                    :isShowDele="!isEdit"
                    :isShowBtn="!isEdit"
                    :isShowTip="!isEdit"
                    :fileType="[
