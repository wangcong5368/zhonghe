    ...
    <el-dialog :title="title" :visible.sync="visible" width="1200px" append-to-body :close-on-click-modal="false" :close-on-press-escape="false">
        <el-form ref="form" :model="form" :rules="rules" label-width="120px">
                ...
                <el-row>
                    ...
                    <el-col :span="12" v-if="SYS_YES_NO.sys_no === form.isSelf">
                        <el-form-item label="代理人姓名" prop="agentName">
                            <el-input v-model="form.agentName" :placeholder="disabled ? '' : '请输入代理人姓名'" clearable maxlength="10" show-word-limit :disabled="disabled" />
                        </el-form-item>
                    </el-col>
                </el-row>
                    ...
                    <el-col :span="12">
                        ...
                        >
                            <el-input
                                ...
                                :placeholder="disabled ? '' : '请输入代理人证件号码'"
                ...
                <el-row v-if="SYS_YES_NO.sys_no === form.isSelf">
                    <el-col :span="12">
                        <el-form-item label="代理人联系方式" prop="agentPhone" :rules="disabled ? [] : [{ validator: this.phoneRule, trigger: 'blur' }]">
                            <el-input
                                ...
                                :placeholder="disabled ? '' : '请输入代理人联系方式'"
                                :disabled="disabled"
                                maxlength="11"
                                show-word-limit
                                clearable
                    ...
                    <el-col :span="12">
                        <el-form-item label="代理人性别" prop="agentSex">
                            <el-select v-model="form.agentSex" :placeholder="disabled ? '' : '请选择代理人性别'" clearable style="width: 100%" :disabled="disabled">
            ...
            <div>
                ...
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="消费者身份类型" prop="consumerIdentityType" :rules="disabled ? [] : [{ required: true, message: '消费者身份类型为必填项', trigger: 'blur' }]">
                            <el-select v-model="form.consumerIdentityType" :placeholder="disabled ? '' : '请选择消费者身份类型'" :disabled="disabled">
                ...
                <el-row>
                    <el-col :span="12">
                        <el-form-item
                            :label="form.consumerIdentityType === DM_IDENTITY_TYPE.LEGAL ? '法人或非法人组织' : '消费者姓名'"
                            prop="name"
                            :rules="disabled ? [] : [{ required: true, message: '消费者姓名为必填项', trigger: 'blur' }]"
                            :label-width="form.consumerIdentityType === DM_IDENTITY_TYPE.LEGAL ? '140px' : '120px'"
                        >
                            <el-input v-model="form.name" :placeholder="disabled ? '' : '请输入消费者姓名'" clearable maxlength="50" show-word-limit :disabled="disabled" />
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item
                ...
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="证件类型" prop="certType" :rules="disabled ? [] : [{ required: true, message: '消费者证件类型为必填项', trigger: 'change' }]">
                            <el-select v-model="form.certType" :placeholder="disabled ? '' : '请选择证件类型'" clearable style="width: 100%" :disabled="disabled">
                                <el-option v-for="dict in dict.type.cert_type" :key="dict.value" :label="dict.label" :value="dict.value"></el-option>
                            </el-select>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item
                            :label="form.consumerIdentityType === DM_IDENTITY_TYPE.LEGAL ? '统一社会信用代码' : '证件号码'"
                            prop="certNum"
                            :rules="
                                disabled
                                    ? []
                ...
                <el-row>
                    <el-col :span="12">
                        ...
                        >
                            <el-select v-model="form.sex" :placeholder="disabled ? '' : '请选择性别'" clearable style="width: 100%" :disabled="disabled">
                                <el-option v-for="dict in dict.type.sys_user_sex" :key="dict.value" :label="dict.label" :value="dict.value"></el-option>
                            </el-select>
                        </el-form-item>
                    </el-col>
                ...
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="民族" prop="nation">
                            <el-input v-model="form.nation" maxlength="26" show-word-limit clearable :placeholder="disabled ? '' : '请输入民族'" :disabled="disabled" />
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="职业" prop="profession">
                            <el-input v-model="form.profession" maxlength="20" show-word-limit clearable :placeholder="disabled ? '' : '请输入职业'" :disabled="disabled" />
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="邮箱" prop="email">
                            <el-input v-model="form.email" show-word-limit clearable :placeholder="disabled ? '' : '请输入邮箱'" :disabled="disabled" />
                        </el-form-item>
                    </el-col>
                    <el-col :span="12" v-if="DEPT_TYPE.insuranceList.includes(form.deptType)">
                        <el-form-item label="身份类型" prop="identityType">
                            <el-select v-model="form.identityType" :placeholder="disabled ? '' : '请选择身份类型'" clearable style="width: 100%" :disabled="disabled">
                ...
                <el-row v-if="DEPT_TYPE.bankList.includes(form.deptType) || DEPT_TYPE.nonBankList.includes(form.deptType) || DEPT_TYPE.insuranceList.includes(form.deptType)">
                    ...
                    <el-col :span="12">
                        <el-form-item label="是否涉及黑产" prop="isBlackIndustry" :rules="disabled ? [] : [{ required: true, message: '是否涉及黑产为必填项', trigger: 'change' }]">
                            <el-select v-model="form.isBlackIndustry" :placeholder="disabled ? '' : '请选择是否涉及黑产'" clearable style="width: 100%" :disabled="disabled">
                                <el-option v-for="dict in dict.type.sys_yes_no" :key="dict.value" :label="dict.label" :value="dict.value"></el-option>
                            </el-select>
                        </el-form-item>
                    </el-col>
                ...
                <el-row v-if="DEPT_TYPE.bankList.includes(form.deptType) || DEPT_TYPE.nonBankList.includes(form.deptType)">
                    <el-col :span="12">
                        ...
                        >
                            <el-select v-model="form.isThirdPartyAgent" :placeholder="disabled ? '' : '请选择是否涉及第三方代理'" clearable style="width: 100%" :disabled="disabled">
                                <el-option v-for="dict in dict.type.sys_yes_no" :key="dict.value" :label="dict.label" :value="dict.value"></el-option>
                            </el-select>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="是否高危客群" prop="isHighRisk" :rules="disabled ? [] : [{ required: true, message: '是否高危客群为必填项', trigger: 'change' }]">
                            <el-select v-model="form.isHighRisk" :placeholder="disabled ? '' : '请选择是否高危客群'" clearable style="width: 100%" :disabled="disabled">
                                <el-option v-for="dict in dict.type.sys_yes_no" :key="dict.value" :label="dict.label" :value="dict.value"></el-option>
                            </el-select>
                        </el-form-item>
                    </el-col>
            ...
            <div>
                ...
                <el-row>
                    ...
                    <el-col :span="12">
                        <el-form-item label="机构所在地区" prop="deptArea">
                            <el-input v-model="form.deptArea" :placeholder="disabled ? '' : '请输入机构所在地区'" clearable maxlength="40" show-word-limit :disabled="disabled" />
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row v-if="DEPT_TYPE.bankList.includes(form.deptType) || DEPT_TYPE.nonBankList.includes(form.deptType)">
                    <el-col :span="12">
                        <el-form-item
                            ...
                            "
                        >
                            <el-input v-model="form.deptHandlerName" :placeholder="disabled ? '' : '请输入业务经办人员'" clearable maxlength="10" show-word-limit :disabled="disabled" />
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item
                            ...
                            "
                        >
                            <el-input v-model="form.deptHandlerPhone" :placeholder="disabled ? '' : '请输入经办人员联系电话'" clearable maxlength="11" show-word-limit :disabled="disabled" />
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row v-if="DEPT_TYPE.bankList.includes(form.deptType) || DEPT_TYPE.nonBankList.includes(form.deptType)">
                    <el-col :span="12">
                        <el-form-item
                            ...
                            "
                        >
                            <el-input v-model="form.deptHandlerCertNum" :placeholder="disabled ? '' : '请输入经办人身份证号'" clearable maxlength="18" show-word-limit :disabled="disabled" />
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="被投诉主体层级" prop="level">
                            <el-input v-model="form.level" :placeholder="disabled ? '' : '请输入被投诉主体层级'" clearable maxlength="10" show-word-limit :disabled="disabled" />
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row v-if="DEPT_TYPE.bankList.includes(form.deptType) || DEPT_TYPE.nonBankList.includes(form.deptType)">
                ...
                <el-row v-if="DEPT_TYPE.bankList.includes(form.deptType) || DEPT_TYPE.nonBankList.includes(form.deptType)">
                    <el-col :span="12">
                        <el-form-item label="级别二" prop="businessType2">
                            <el-input v-model="form.businessType2" :placeholder="disabled ? '' : '请输入级别二'" clearable maxlength="20" show-word-limit :disabled="disabled" />
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="级别三" prop="businessType3">
                            <el-input v-model="form.businessType3" :placeholder="disabled ? '' : '请输入级别三'" clearable maxlength="20" show-word-limit :disabled="disabled" />
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row v-if="DEPT_TYPE.bankList.includes(form.deptType) || DEPT_TYPE.nonBankList.includes(form.deptType)">
                    <el-col :span="12">
                        <el-form-item
                            ...
                            "
                        >
                            <el-select v-model="form.handleChannel" :placeholder="disabled ? '' : '请选择业务办理渠道'" clearable style="width: 100%" :disabled="disabled">
                    ...
                    <el-col :span="12">
                        <el-form-item
                            ...
                            "
                        >
                            <el-select v-model="form.bankComplaintType" :placeholder="disabled ? '' : '请选择投诉分类'" clearable style="width: 100%" :disabled="disabled">
                ...
                <el-row v-if="DEPT_TYPE.insuranceList.includes(form.deptType)">
                    ...
                    <el-col :span="12">
                        <el-form-item label="险种类别2" prop="insuranceType2">
                            <el-input v-model="form.insuranceType2" :placeholder="disabled ? '' : '请输入险种类别2'" clearable maxlength="40" show-word-limit :disabled="disabled" />
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row v-if="DEPT_TYPE.insuranceList.includes(form.deptType)">
                    <el-col :span="12">
                        <el-form-item label="产品销售渠道" prop="saleChannel">
                            <el-select v-model="form.saleChannel" :placeholder="disabled ? '' : '请选择产品销售渠道'" clearable style="width: 100%" :disabled="disabled">
                    ...
                    <el-col :span="12">
                        <el-form-item label="保险消费投诉事由分类" prop="insuranceComplaintType" label-width="165px">
                            <el-select v-model="form.insuranceComplaintType" :placeholder="disabled ? '' : '请选择保险消费投诉事由分类'" clearable style="width: 100%" :disabled="disabled">
                    ...
                    <el-col :span="12">
                        <el-form-item label="金融服务发生地" prop="financialServiceArea">
                            <el-cascader
                                ...
                                :placeholder="disabled ? '' : '请选择金融服务发生地'"
                                clearable
                                style="width: 100%"
                            />
                        </el-form-item>
                    </el-col>
                    <el-col :span="12" v-if="DEPT_TYPE.bankList.includes(this.form.deptType) || DEPT_TYPE.nonBankList.includes(this.form.deptType)">
                ...
                <el-row>
                    <el-col :span="12">
                        ...
                        >
                            <el-select v-model="form.needCheck" :placeholder="disabled ? '' : '请选择调解员向当事人电话确认'" clearable style="width: 100%" :disabled="disabled">
                                <el-option v-for="dict in dict.type.sys_yes_no" :key="dict.value" :label="dict.label" :value="dict.value"></el-option>
                            </el-select>
                        </el-form-item>
                    </el-col>
            ...
            <el-row>
                <el-col :span="12">
                    <el-form-item
                        ...
                        "
                    >
                        <el-input v-model="form.deptContact" :placeholder="disabled ? '' : '请输入机构代表姓名'" clearable maxlength="10" show-word-limit :disabled="disabled" />
                    </el-form-item>
                </el-col>
                <el-col :span="12">
                    <el-form-item
                        ...
                        "
                    >
                        <el-select v-model="form.deptContactSex" :placeholder="disabled ? '' : '请选择性别'" clearable style="width: 100%" :disabled="disabled">
                            <el-option v-for="dict in dict.type.sys_user_sex" :key="dict.value" :label="dict.label" :value="dict.value"></el-option>
                        </el-select>
                    </el-form-item>
                </el-col>
            ...
            <el-row>
                <el-col :span="12">
                    <el-form-item
                        ...
                        "
                    >
                        <el-select v-model="form.deptContactCertType" :placeholder="disabled ? '' : '请选择证件类型'" clearable style="width: 100%" :disabled="disabled">
                            <el-option v-for="dict in dict.type.cert_type" :key="dict.value" :label="dict.label" :value="dict.value"></el-option>
                        </el-select>
                    </el-form-item>
                </el-col>
            ...
            <el-row>
                <el-col :span="12">
                    <el-form-item
                        ...
                        "
                    >
                        <el-input v-model="form.product" :placeholder="disabled ? '' : '请输入涉及产品或服务名称'" clearable maxlength="40" show-word-limit :disabled="disabled" />
                    </el-form-item>
                </el-col>
                <el-col :span="12">
                    <el-form-item
                        ...
                        "
                    >
                        <el-input v-model="form.contract" :placeholder="disabled ? '' : '请输入涉及产品或服务合同号'" clearable maxlength="40" show-word-limit :disabled="disabled" />
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row>
            ...
            <el-row v-if="form.deptAcceptMediate">
                <el-col :span="12">
                    ...
                    >
                        <el-select v-model="form.deptAcceptMediate" :placeholder="disabled ? '' : '请选择金融机构是否接受调解'" style="width: 100%" :disabled="disabled">
                            <el-option v-for="dict in dict.type.sys_yes_no" :key="dict.value" :label="dict.label" :value="dict.value"></el-option>
                        </el-select>
                    </el-form-item>
                </el-col>
            ...
            <el-row v-if="DEPT_TYPE.insuranceList.includes(form.deptType) && form.deptAcceptMediate">
                <el-col :span="12">
                    <el-form-item label="投保人" prop="policyholder">
                        <el-input v-model="form.policyholder" :placeholder="disabled ? '' : '请输入投保人'" clearable maxlength="10" show-word-limit :disabled="disabled" />
                    </el-form-item>
                </el-col>
                <el-col :span="12">
                    <el-form-item label="被保险人" prop="insured">
                        <el-input v-model="form.insured" :placeholder="disabled ? '' : '请输入被保险人'" clearable maxlength="10" show-word-limit :disabled="disabled" />
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row v-if="DEPT_TYPE.insuranceList.includes(form.deptType) && form.deptAcceptMediate">
            ...
            <el-row v-if="DEPT_TYPE.insuranceList.includes(form.deptType) && form.deptAcceptMediate">
                <el-col :span="12">
                    <el-form-item label="业务所属支公司" prop="businessCompany">
                        <el-input v-model="form.businessCompany" :placeholder="disabled ? '' : '请输入业务所属支公司'" clearable maxlength="100" show-word-limit :disabled="disabled" />
                    </el-form-item>
                </el-col>
                <el-col :span="12">
                    <el-form-item label="销售人员（网点、理赔人员）" prop="salesman" label-width="200px">
                        <el-input v-model="form.salesman" :placeholder="disabled ? '' : '请输入销售人员'" clearable maxlength="10" show-word-limit :disabled="disabled" />
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row v-if="DEPT_TYPE.insuranceList.includes(form.deptType) && form.deptAcceptMediate">
                <el-col :span="12">
                    <el-form-item label="销售、网点、理赔工号" prop="salesmanJobNum" label-width="160px">
                        <el-input v-model="form.salesmanJobNum" :placeholder="disabled ? '' : '请输入销售、网点、理赔工号'" clearable maxlength="20" show-word-limit :disabled="disabled" />
                    </el-form-item>
                </el-col>
                <el-col :span="12">
                    <el-form-item label="销售人员、理赔人员证件号码" prop="salesmanCertNum" label-width="200px">
                        <el-input v-model="form.salesmanCertNum" :placeholder="disabled ? '' : '请输入销售人员、理赔人员证件号码'" clearable maxlength="18" show-word-limit :disabled="disabled" />
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row v-if="form.deptAcceptMediate">
...
<script>
import { updateDisputeMediation, updateDisputeMediationAttachment, getDisputeMediationExpandInfo, saveOrUpdateDisputeMediationExpand, getProvinces, getCities } from '@/api/project/disputeMediation';
