      ...
      <el-row class="investigation-wrapper">
        <el-col class="dialog-left" :span="13">
          ...
          <div style="padding: 0 20px">
            <record-form ref="investigationRecordForm" :initial-data="formData" />
          </div>
        ...
        <el-col class="dialog-right" :span="11">
          <div class="right-t">
            ...
            <el-form ref="form" :model="diaputeForm" label-width="120px" hide-required-asterisk>
              <div>
                <div class="region-title">*新增调查记录</div>
                <el-row class="line-row">
                  <el-col :span="24">
                    <el-form-item label="参加人" prop="participant">
                      <el-input v-model="diaputeForm.participant" placeholder="请输入参加人" maxlength="50" show-word-limit />
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row class="line-row">
                  <el-col :span="24">
                    <el-form-item label="被调查人" prop="respondent">
                      <el-input v-model="diaputeForm.respondent" placeholder="请输入被调查人" maxlength="100"
                                show-word-limit />
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row class="line-row">
                  <el-col :span="24">
                    <el-form-item label="记录（必填）" prop="record">
                      <el-input v-model="diaputeForm.record" type="textarea" placeholder="请输入被调查人" maxlength="500"
...
export default {
  ...
  methods: {
    ...
    minimize(event) {
      this.$emit(
        'minimize',
        "新增调查记录:" + this.row.workOrderId,
        { row: this.row, form: { ...this.$refs.investigationRecordForm.getFormData() } },
        "新增调查记录",
        "success",
        event.clientX,
        event.clientY,
...
.investigation-dialog ::v-deep .el-dialog__header {
  padding: 0;
}

.investigation-dialog ::v-deep .el-dialog__body {
  padding-top: 0;
}
