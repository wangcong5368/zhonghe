      ...
      >
        <template slot-scope="scope">
          <el-button
            ...
            type="text"
            :class="{
              'edit-button': scope.row.status === 1 || scope.row.status === 11,
            }"
            :icon="
                ...
                >
                  <div class="history-item">
                    <div class="history-header">
                      <span class="history-title">{{ item.returnRemark }}</span>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="代字/红头" prop="officialHeader">
          <el-input
            v-model="form.officialHeader"
            placeholder="请输入代字/红头"
          />
        </el-form-item>
...
import addDialog from "../draft/addDialog.vue";
