            ...
            <el-form ref="documentForm" :model="form" :rules="rules" class="document-form">
                ...
                <table class="word-table">
                    <tr>
                        ...
                        <td class="input-cell">
                            <el-input
                                v-model="form.superiorDocNumber"
                                placeholder="自由输入不超20字符"
                                maxlength="20"
                                show-word-limit
                        ...
                        <td class="input-cell">
                            <el-input
                                v-model="form.incomingDocNumber"
                                placeholder="自由输入不超20字符"
                                maxlength="20"
                                show-word-limit
                                :disabled="isView || (putEditStatus !== null && putEditStatus !== 7)"
                    ...
                    <tr>
                        ...
                        <td class="input-cell">
                            <el-select v-model="form.type" placeholder="下拉选择" :disabled="isView || (putEditStatus !== null && putEditStatus !== 7)" class="table-select">
                                <el-option v-for="dict in dict.type.document_receive_type" :key="dict.value" :label="dict.label" :value="dict.value"></el-option>
                            </el-select>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="input-cell" colspan="3">
                            <el-input
                                v-model="form.originatingUnit"
                                placeholder="自由输入不超100字符"
                                maxlength="100"
                                show-word-limit
                                :disabled="isView || (putEditStatus !== null && putEditStatus !== 7)"
                                class="table-input"
                ...
                <table class="word-table">
                    <tr>
                        ...
                        <td class="input-cell" colspan="3">
                            <FileUpload v-if="!isView && (putEditStatus === null || putEditStatus === 7)" v-model="form.attachments" @upload-success="handleFileChange" style="margin: 5px 10px" />
                ...
                <table class="word-table">
                    <tr>
                        ...
                        <td class="input-cell" colspan="3">
                            <div class="approval-section">
                                <el-input v-model="form.directorInstruction" type="textarea" :rows="3" placeholder="填写意见" :disabled="isSectionDisabled(2)" class="table-textarea"></el-input>
                                <QuickReply
                                    v-if="!isSectionDisabled(2)"
                                    style="margin: 5px 10px"
                                    :onSelect="phrase => handleSelectPhrase('director', phrase)"
                                    :superviseId="$route.query.id"
                                    :inputContent="form.directorInstruction"
                                    :buttonWidth="'90px'"
                                    :buttonHeight="'30px'"
                    ...
                    <tr>
                        ...
                        <td class="input-cell" colspan="3">
                            <div class="approval-section">
                                <el-input v-model="form.comprehensiveOpinion" type="textarea" :rows="3" placeholder="填写意见" :disabled="isSectionDisabled(1)" class="table-textarea"></el-input>
                                <QuickReply
                                    v-if="!isSectionDisabled(1)"
                                    style="margin: 5px 10px"
                                    :onSelect="phrase => handleSelectPhrase('comprehensive', phrase)"
                                    :superviseId="$route.query.id"
                                    :inputContent="form.comprehensiveOpinion"
                                    :buttonWidth="'100px'"
                                    :buttonHeight="'30px'"
                                    @collected="handleCollected"
                                />
                    ...
                    <tr>
                        ...
                        <td class="input-cell" colspan="3">
                            <div class="approval-section">
                                <el-input v-model="form.leadDeptOpinion" type="textarea" :rows="3" placeholder="填写意见" :disabled="isSectionDisabled(3)" class="table-textarea"></el-input>
                                <QuickReply
                                    v-if="!isSectionDisabled(3)"
                                    style="margin: 5px 10px"
                                    :onSelect="phrase => handleSelectPhrase('leadDept', phrase)"
                                    :superviseId="$route.query.id"
                                    :inputContent="form.leadDeptOpinion"
                                    :buttonWidth="'90px'"
                                    :buttonHeight="'30px'"
                                    @collected="handleCollected"
                                />
                                <!-- 分发给部门经理的附件 -->
                                <el-form-item label="附件" prop="managerAttachment" style="margin-top: 10px" v-if="form.managerAttachment && putEditStatus !== 3">
                                    <FileUpload v-if="!isView && !isSectionDisabled(3)" v-model="form.managerAttachment" style="margin: 5px 10px" />
                                    <div v-else-if="form.managerAttachment" class="attachment-list">
                                        <div v-for="(filePath, index) in getAttachmentList(form.managerAttachment)" :key="index" class="attachment-item" v-if="filePath.trim()">
                                ...
                                <div class="dept-distribution" v-if="!isSectionDisabled(3)">
                                    <div class="dept-distribution-content">
                                        ...
                                        <el-select v-model="form.deptDistribution" multiple placeholder="请选择部门经理分发" style="width: 100%" :disabled="isSectionDisabled(3)">
                                            <el-option v-for="item in departmentManagers" :key="item.id" :label="item.label" :value="item.id"></el-option>
                                        </el-select>
                                    </div>
                                ...
                                <div class="handler-info" v-if="form.leadDeptHandler">
                                    <span class="handler-time">处理人: {{ form.leadDeptHandler }} 日期: {{ form.leadDeptDate }} 时间: {{ form.leadDeptTime }}</span>
                                </div>
                            </div>
                        </td>
                    </tr>
                        ...
                        <td class="input-cell" colspan="3">
                            ...
                            <div class="read-section" v-if="showReadButton()">
                                <el-form-item label="处理内容" prop="readOpinion">
                                    <el-input v-model="form.readOpinion" type="textarea" :rows="3" placeholder="填写处理内容" class="table-textarea"></el-input>
                                    <QuickReply
                                        style="margin: 5px 10px"
                                        :onSelect="phrase => handleSelectPhrase('read', phrase)"
                                        :superviseId="$route.query.id"
                                        :inputContent="form.readOpinion"
                                        :buttonWidth="'90px'"
                                        :buttonHeight="'30px'"
                                        @collected="handleCollected"
                                    />
                            ...
                            <div class="dept-distribution" v-if="!isSectionDisabled(4)">
                                <el-form-item label="部门人员分发" prop="staffDistribution">
                                    <el-select v-model="form.staffDistribution" multiple placeholder="请选择分发人员" style="width: 100%">
                                        <el-option v-for="item in currentDeptUsers" :key="item.userId" :label="item.nickName" :value="item.userId"></el-option>
                                    </el-select>
                                </el-form-item>
                                <!-- 部门经理处理意见 -->
                                <el-form-item label="处理意见" prop="deptOpinion">
                                    <el-input v-model="form.deptOpinion" type="textarea" :rows="3" placeholder="填写处理意见" class="table-textarea"></el-input>
                                    <QuickReply
                                        style="margin: 5px 10px"
                                        :onSelect="phrase => handleSelectPhrase('dept', phrase)"
                                        :superviseId="$route.query.id"
                                        :inputContent="form.deptOpinion"
                                        :buttonWidth="'90px'"
                                        :buttonHeight="'30px'"
                                        @collected="handleCollected"
                                    />
                ...
                <table class="word-table">
                    <tr>
                        ...
                        <td class="input-cell">
                            <el-input v-model="form.issuingAgency" placeholder="自由输入" :disabled="isView || (putEditStatus !== null && putEditStatus !== 7)" class="table-input"></el-input>
                        </td>
                    </tr>
                    <tr>
