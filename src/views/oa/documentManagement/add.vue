      ...
      <el-form ref="documentForm" :model="form" :rules="rules" class="document-form">
          ...
          <table class="word-table" v-if="shouldShowField('contactPerson') || shouldShowField('contactPhone')">
            <tr>
              ...
              <td class="input-cell" v-if="shouldShowField('contactPerson')">
                <el-input v-model="form.contactPerson" placeholder="请输入联系人" :disabled="isReadOnly"
                  class="table-input"></el-input>
              </td>
              <td class="label-cell" v-if="shouldShowField('contactPhone')">联系电话</td>
              <td class="input-cell" v-if="shouldShowField('contactPhone')">
                <el-input v-model="form.contactPhone" placeholder="请输入联系电话" :disabled="isReadOnly"
                  class="table-input"></el-input>
              </td>
            </tr>
          </table>
          ...
          <tr>
            ...
            <td class="input-cell" v-if="shouldShowField('partNumber')">
              <div class="part-number-wrapper">
                <el-input v-model="form.partNumber" placeholder="请输入打印份数" :disabled="isReadOnly" class="table-input"
                  @input="handlePartNumberInput" @keydown="handlePartNumberKeydown"></el-input>
                <div class="part-number-controls">
                  <button type="button" class="part-number-btn part-number-decrease" @click="decreasePartNumber"
                    :disabled="isReadOnly || form.partNumber <= 1">-</button>
                  <button type="button" class="part-number-btn part-number-increase" @click="increasePartNumber"
                    :disabled="isReadOnly || form.partNumber >= 999">+</button>
                </div>
              </div>
            </td>
            <td class="label-cell" v-if="shouldShowField('issuingDate')">印发日期</td>
            <td class="input-cell" v-if="shouldShowField('issuingDate')">
              <el-date-picker v-model="form.issuingDate" type="date" placeholder="选择印发日期"
                value-format="yyyy-MM-dd HH:mm:ss" :disabled="isReadOnly" class="table-date-picker"></el-date-picker>
            </td>
          </tr>
        </table>
        ...
        <table class="word-table">
            ...
            <td class="input-cell" colspan="3">
              <div class="approval-section">
                ...
                <div class="handler-info" v-if="comprehensiveProcessHandler">
                  <span class="handler-time">处理人: {{ comprehensiveProcessHandler }} 日期: {{ comprehensiveProcessDate }}
                    时间: {{
          ...
          <tr>
            ...
            <td class="input-cell" colspan="3">
              <el-input v-model="form.documentRemark" type="textarea" :rows="2" placeholder="输入备注"
